  ...
  return (
    <>
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl bottom-36 left-0 fixed z-[500] font-sans duration-300"
      >
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl top-36 left-[-30px] sm:left-0 fixed z-[500] font-sans duration-300"
      >
      ...
      <motionDiv.h1
        ...
        className="font-bold text-3xl lg:text-5xl bottom-36 text-center w-[90%] md:w-[70%] lg:w-[60%] left-1/2 fixed z-[500] font-sans duration-300"
      >
