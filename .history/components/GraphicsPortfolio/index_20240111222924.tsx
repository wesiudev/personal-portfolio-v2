...
const GraphicsPortfolio: React.FC = () => {
  ...
  const donut2PosX = useTransform(scrollYProgress, [0.1, 0.3], [1, 0]);
  const donut2PosY = useTransform(scrollYProgress, [0.1, 0.6], [0.5, -7]);
  ...
  return (
    <>
      ...
      >
        <span className="bg-yellow-300 select-none leading-[1.2] px-1">
          I have expertise in JavaScript programming and a desire to learn 3D
          graphics.
        </span>
      </motionDiv.h1>
      <motionDiv.div style={{ opacity: menuOpacity }}>
        <Canvas
          style={{
            position: "fixed",
            top: "50%",
