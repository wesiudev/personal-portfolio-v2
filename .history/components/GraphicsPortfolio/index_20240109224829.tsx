...
const GraphicsPortfolio: React.FC = () => {
  ...
  const scale = useTransform(scrollYProgress, [0.1, 0.5, 1], [0, 2, 40]);
  ...
  const scale2 = useTransform(scrollYProgress, [0.1, 0.3, 0.8], [0, 2, 30]);
  const rotateX2 = useTransform(scrollYProgress, [0.1, 0.3, 1], [0, 5, 5.3]);
