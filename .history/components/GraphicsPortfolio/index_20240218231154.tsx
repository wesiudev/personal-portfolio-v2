...
const GraphicsPortfolio: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="bg-yellow-300 px-6 box-decoration-clone select-none w-max">
          Hi, I'm wesiudev
        </div>
      </motionDiv.h1>
      <motionDiv.h1
      ...
      >
        <div className="bg-yellow-300 select-none px-6 box-decoration-clone text-[38px] sm:text-[5xl] lg:text-7xl xl:text-8xl w-max">
          Creative Developer
        </div>
      </motionDiv.h1>
      <motionDiv.h1
      ...
      >
        <div className="bg-yellow-300 shadow-xl shadow-black select-none leading-[1.2] px-6 box-decoration-clone text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl">
