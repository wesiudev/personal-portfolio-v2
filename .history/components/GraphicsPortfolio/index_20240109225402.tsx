...
const GraphicsPortfolio: React.FC = () => {
  ...
  const scale2 = useTransform(scrollYProgress, [0.1, 0.5, 1], [0, 2, 20]);
  const rotateX2 = useTransform(scrollYProgress, [0.1, 0.5, 1], [1, 5, 5.3]);
  const rotateY2 = useTransform(scrollYProgress, [0.4, 0.6], [0, 3]);
  const rotateZ2 = useTransform(scrollYProgress, [0.4, 0.6, 1], [0, 3, 6]);
  const donutPosX2 = useTransform(scrollYProgress, [0.1, 0.3], [-3, 0]);
  const donutPosY2 = useTransform(scrollYProgress, [0.1, 0.5], [0, 0]);
  const donutPosZ2 = useTransform(scrollYProgress, [0.1, 0.5], [1, 3]);
