  ...
  return (
    <>
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl top-36 left-[-300px] sm:left-0 fixed z-[500] font-sans"
      >
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl bottom-36 right-[10vw] sm:right-0 fixed z-[500] font-sans"
      >
