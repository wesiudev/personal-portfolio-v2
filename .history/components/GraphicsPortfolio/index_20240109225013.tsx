...
const GraphicsPortfolio: React.FC = () => {
  ...
  const scale = useTransform(scrollYProgress, [0.1, 0.5, 1], [0, 2, 20]);
  const rotateX = useTransform(scrollYProgress, [0.1, 0.5, 1], [1, 5, 5.3]);
  ...
  const donutPosY = useTransform(scrollYProgress, [0.1, 0.5], [0, 0]);
  const donutPosZ = useTransform(scrollYProgress, [0.1, 0.5], [1, 3]);

  const scale2 = useTransform(scrollYProgress, [0.1, 0.3, 1], [0, 2, 40]);
  const rotateX2 = useTransform(scrollYProgress, [0.1, 0.3, 1], [1, 6, 6.3]);
  const rotateY2 = useTransform(scrollYProgress, [0.4, 0.3], [0, 3]);
  const rotateZ2 = useTransform(scrollYProgress, [0.4, 0.3, 1], [0, 3, 6]);
  const donutPosX2 = useTransform(scrollYProgress, [0.1, 0.2], [0, 1]);
