...
const GraphicsPortfolio: React.FC = () => {
  ...
  const scale = useTransform(scrollYProgress, [0.2, 0.7, 1], [0, 2, 25]);
  const rotateX = useTransform(scrollYProgress, [0.1, 0.7, 1], [0, 5.5, 6.3]);
  ...
  return (
    <>
      ...
      >
        <span className="bg-yellow-300 select-none px-1 w-max">
          Hi, I'm wesiudev
        </span>
      </motionDiv.h1>
      <motionDiv.h1
      ...
      >
        <span className="bg-yellow-300 select-none px-1 text-[42px] lg:text-7xl xl:text-8xl w-max">
          Creative Developer
        </span>
      </motionDiv.h1>
      <motionDiv.h1
