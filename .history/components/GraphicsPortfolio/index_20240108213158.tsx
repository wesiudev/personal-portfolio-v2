...
interface ModelProps {
  ...
  donutPosX: MotionValue<number>;
  donutPosY: MotionValue<number>;
  donutPosZ: MotionValue<number>;
}
...
const GraphicsPortfolio: React.FC = () => {
  ...
  const rotateX = useTransform(scrollYProgress, [0.2, 0.5], [0, 3.3]);
  const rotateY = useTransform(scrollYProgress, [0.4, 0.6], [0, 1.3]);
  const donutPosX = useTransform(scrollYProgress, [0.2, 0.3], [0, 1]);
  const donutPosY = useTransform(scrollYProgress, [0.2, 0.5], [1, 0]);
  const donutPosZ = useTransform(scrollYProgress, [0.2, 0.5], [1, 3]);
