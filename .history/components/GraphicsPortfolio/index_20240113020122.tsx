  ...
  return (
    <>
      ...
      <motionDiv.h1
        ...
        className="font-bold text-6xl lg:text-7xl xl:text-8xl bottom-36 left-0 fixed z-[500] font-sans"
      >
      ...
      >
        <span className="bg-yellow-300 select-none px-1 text-[42px] lg:text-7xl xl:text-8xl">
          Creative Developer
        </span>
      </motionDiv.h1>
      <motionDiv.h1
