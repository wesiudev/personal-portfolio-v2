...
const GraphicsPortfolio: React.FC = () => {
  ...
  return (
    <>
      <div className="h-[1000vh] w-screen relative mt-[700vh] bg-yellow-500">
        <div className="z-[502] sticky top-0 h-screen bg-red-500">SIEMA</div>
      </div>
      <motionDiv.div
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl bottom-36 text-right md:text-left right-0 fixed z-[500] font-sans"
      >
      ...
      <motionDiv.h1
        ...
        className="font-bold text-5xl lg:text-8xl bottom-36 text-center w-[90%] md:w-[70%] lg:w-[60%] right-1/2 fixed z-[500] font-sans"
      >
        <span className="bg-yellow-300">Hello there! My name is Pawel, and I'm an enthusiastic developer with
          expertise in front-end and ongoing desire to learn new things.</span>
      </motionDiv.h1>
      <Canvas
        style={{
          position: "fixed",
