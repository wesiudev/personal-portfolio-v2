...
const GraphicsPortfolio: React.FC = () => {
  ...
  const scale2 = useTransform(scrollYProgress, [0.1, 0.3, 0.8], [0, 2, 20]);
  const rotateX2 = useTransform(scrollYProgress, [0.1, 0.5, 1], [0, 5, 5.3]);
  ...
  const donutPosY2 = useTransform(scrollYProgress, [0.1, 0.5], [-2, 0]);
