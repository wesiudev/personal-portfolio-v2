...
export default function MyStory() {
  return (
    ...
    >
      ...
      <div className="text-[#F7E11F] text-lg lg:text-2xl w-[80vw] lg:w-[70vw] xl:w-[60vw] mt-16">
        <p className="">
      ...
      <div className="text-white font-light text-xl italic opacity-50 h-screen flex items-center justify-center">
        wesiu.dev 2024
      </div>
    </div>
  );
