...
export default function MyStory() {
  return (
    <div
      id="about"
      className="w-screen flex flex-col items-center text-center relative min-h-screen mt-[50vh]"
    >
      ...
      <div className="text-white font-light text-xl italic duration-200 h-screen flex flex-col items-center justify-center group z-[600] relative">
        <span className="opacity-50 group-hover:opacity-100">
          wesiu.dev 2024
        </span>
        <div className="flex flex-row items-center w-full justify-evenly">
          <Link title="Send me an email" href="mailto:wesiudev@gmail.com">
            <FaEnvelope className="opacity-50 h-8 w-8 mt-4 hover:opacity-100" />
          </Link>
          <Link title="Call me" href="tel:+48721417154">
            <FaPhone className="opacity-50 h-8 w-8 mt-4 hover:opacity-100 />
          </Link>
        </div>
      </div>
    </div>
