...
export default function ProjectShowcase({ menuOpacity }: { menuOpacity: any }) {
  ...
  return (
    <>
      <motionDiv.div
        style={{ opacity: 1 }}
        className={`h-screen duration-300 fixed left-[50%] top-[50%] -translate-x-[50%] -translate-y-[50%] z-[505]`}
      >
        <motionDiv.h2
          style={{ opacity: h1TextOpacity, translateY: h1TextTranslateY }}
          className="bg-black bg-opacity-40 !z-[550] relative font-sans font-bold italic text-2xl lg:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
      </motionDiv.div>
      ...
      >
        ...
        >
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-48 ">
                <motionDiv.div
                  style={{
