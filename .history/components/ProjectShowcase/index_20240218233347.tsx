          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  <h2 className="bg-yellow-300 w-max p-3 rounded-br-xl font-anta text-center text-black font-bold text-2xl lg:text-3xl xl:text-5xl drop-shadow-md shadow-black">
                    {item.name}
                  </h2>
                  <div className="p-3">
