...
export default function ProjectShowcase() {
  ...
  const h1TextTranslateXPC = useTransform(
    scrollYProgress,
    [0, 0.1, 0.9, 1],
    ["-200px", "0px", "0px", "-200px"]
  );
  ...
  return (
    <>
      <div
        ref={mainWrapper}
        className="flex-col flex w-screen relative mt-[450vh]"
      >
        <div className="h-[10vh] relative w-max">
          <motionDiv.h2
            style={{
              opacity: h1TextOpacity,
              translateX: h1TextTranslateXPC,
            }}
            className="hidden lg:block bg-yellow-300 z-[550] sticky left-12 font-sans w-max top-24 text-4xl font-bold xl:text-5xl text-black select-none text-center"
          >
            Projects Showcase
          </motionDiv.h2>
        </div>
