  ...
  return (
    <div className="relative h-max py-3 lg:py-24 my-12 lg:my-0 flex items-center duration-75 px-6 lg:px-12">
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
        <ProjectImages
          images={[
            "/images/projects/webadmin/login.png",
            "/images/projects/webadmin/add-service.png",
            "/images/projects/webadmin/edit-post.png",
            "/images/projects/webadmin/new-post.png",
            "/images/projects/webadmin/statistics.png",
          ]}
        />
        <div
        ...
        >
          ...
          <div className="p-3">
            ...
            <div className="flex flex-row items-start flex-wrap -ml-3">
              <p className="font-sans text-sm lg:text-base xl:text-lg ml-3">
                React
              </p>
              <p className="font-sans text-sm lg:text-base xl:text-lg ml-3">
                Next13 SSR
            ...
            <div className="mt-3 flex flex-row items-center space-x-4 not-italic">
              <Link
                ...
                target="_blank"
                href="https://github.com/wesiudev/manicuregrudziadz/tree/main/app/(admin)"
                className="flex flex-row items-center"
              >
                <FaCode className="mr-2 h-7 w-7" /> Example code
              </Link>
            </div>
          </div>
        </div>
