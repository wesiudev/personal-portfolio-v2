            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                <div className="relative ">
                  <div className="flex flex-row space-x-2 bottom-3 -translate-x-1/2 lg:-translate-x-0 lg:left-3 lg:top-1/2 lg:-translate-y-1/2 absolute lg:space-y-3 bg-black bg-opacity-50 p-1.5">
