...
import AdminPanelShowcase from "./AdminPanelShowcase";
          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  <h2 className="bg-yellow-300 w-max p-3 shadow-sm shadow-black rounded-br-xl font-anta text-center text-black font-bold text-2xl lg:text-3xl xl:text-5xl ">
                    {item.name}
                  </h2>
                  <div className="p-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 md:gap-4 lg:gap-0 xl:gap-4">
                      <div className="flex flex-col border-2 border-yellow-300">
                        <h2 className="md:-ml-0 lg:-ml-3 xl:-ml-0 px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                          Colors
                        </h2>
                        <div className="-ml-3 z-50 h-max flex flex-row lg:-ml-4 mt-3 p-2 pr-6 w-max bg-gray-300 bg-opacity-20">
                      ...
                      <div className="flex flex-col">
                        <h2 className="-ml-3 px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                          Stack
                        </h2>
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="text-sm lg:text-base xl:text-lg font-dosis mt-3">
                          {item.structure}
                        </p>{" "}
                      </div>
                      <div className="flex flex-col">
                    ...
                    <div className="mt-3 flex flex-row items-center space-x-4 ">
                      ...
                      >
                        <FaCode className="mr-2 h-7 w-7 text-yellow-300" />{" "}
                        Source code
                      </Link>
                      <Link
                        href={item.link}
                        ...
                        className="flex flex-row items-center"
                      >
                        <FaLink className="mr-2 h-6 w-6 text-yellow-300" />
                        Visit Page
                      </Link>
                    </div>
                  </div>
