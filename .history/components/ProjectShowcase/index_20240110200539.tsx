...
export default function ProjectShowcase({ menuOpacity }: { menuOpacity: any }) {
  ...
  return (
    <>
      ...
      >
        <div className="sticky top-36 z-[504] w-screen h-screen ">
          <div className="top-0 h-screen lg:h-max">
            <motionDiv.div
              style={{ position: project1Pos, opacity: project1Opacity }}
              className="h-[100vh] grid grid-cols-2 duration-75 py-3 px-3"
            >
              <Image
              ...
              <div className="">
                <motionDiv.h2
                  style={{ translateX: project1TranslateXLeft }}
                  className="font-lato font-bold text-5xl text-zinc-800 drop-shadow-md shadow-black"
                >
                  {projects[2].name}
                </motionDiv.h2>
                <motionDiv.p
