  ...
  return (
    <>
      <motionDiv.h2
        ...
        className="bg-black bg-opacity-40 z-[550] fixed left-1/2 font-sans font-bold w-max top-0 text-2xl lg:text-3xl xl:text-4xl text-white select-none text-center p-3 rounded-xl"
      >
        Projects Showcase
      </motionDiv.h2>
      <div ref={mainWrapper} className=" flex w-screen relative mt-[525vh]">
        <motionDiv.div className="z-[504] top-0 w-screen flex flex-col mt-72 lg:mt-36">
