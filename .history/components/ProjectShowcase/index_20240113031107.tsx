      ...
      >
        <div className="h-[50vh] relative w-screen">
          <motionDiv.h2
            ...
            className="hidden lg:block bg-yellow-300 z-[550] sticky left-1/2 font-sans w-max top-24 text-4xl font-bold xl:text-5xl text-black select-none text-center"
          >
            Projects Showcase
          </motionDiv.h2>
        </div>
        ...
        <motionDiv.div className="z-[504] top-0 w-screen flex flex-col">
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                <motionDiv.div
                  className="italic mt-4 lg:mt-0  text-white bg-slate-800 bg-opacity-70 overflow-hidden rounded-xl h-max"
                  style={{
