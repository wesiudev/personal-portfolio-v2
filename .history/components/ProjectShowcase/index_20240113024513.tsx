    ...
    <>
      ...
      >
        <motionDiv.h2
          ...
          className="bg-black bg-opacity-40 z-[550] sticky top-0 font-sans font-bold italic w-max top-0 text-2xl lg:text-5xl xl:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
        <motionDiv.div className="z-[504] top-0 w-screen flex flex-col mt-[70vh] lg:mt-36">
