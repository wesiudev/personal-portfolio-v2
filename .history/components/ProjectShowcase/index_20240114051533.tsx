    ...
    <>
      ...
      >
        <motionDiv.div
          ...
          className="h-[20vh] lg:h-[50vh] relative w-screen flex items-center justify-center"
        >
          <motionDiv.h2 className="bg-yellow-300 z-[550] sticky font-sans w-max top-24 text-3xl font-bold xl:text-7xl text-black select-none text-center">
            Projects Showcase
          </motionDiv.h2>
        </motionDiv.div>
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                <div className="relative ">
                  <div className="flex flex-row space-x-2 lg:space-x-4 bottom-3 left-1/2 -translate-x-1/2 absolute bg-black bg-opacity-60 p-1.5">
