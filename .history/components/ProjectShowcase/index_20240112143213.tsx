              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-72 lg:mt-0">
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    className="absolute bottom-6 right-6 text-blue-400 hover:text-gray-400 hover:bg-black hover:bg-opacity-70 p-2 rounded-md duration-200 border-2 border-black not-italic flex flex-row items-center mt-3 text-xl"
                  >
