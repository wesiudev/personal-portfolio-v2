        ...
        >
          {projects.map((item: any, i: any) => (
            <motionDiv.div
              ...
              className="h-[100vh] flex items-center duration-75 py-3 px-6 lg:px-24 bg-slate-400 bg-opacity-50 rounded-xl border-4 border-slate-600"
            >
              <div className=" w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 lg::mt-0">
                <motionDiv.div
                  style={{
                ...
                >
                  <h2 className="bg-yellow-300 my-3 lg:mt-0 w-max mx-auto lg:mx-0 text-black font-sans font-bold text-5xl drop-shadow-md shadow-black px-1">
                    {item.name}
                  </h2>
                  <p className="font-sans text-3xl">{item.shortDescription}</p>
                  <h2 className="font-bold text-2xl mt-3 mb-1">Stack</h2>
