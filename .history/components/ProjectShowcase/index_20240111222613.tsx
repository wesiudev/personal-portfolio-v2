    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="bg-black w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 lg::mt-0">
              <motionDiv.div
                style={{
              ...
              <motionDiv.div
                className="px-3 lg:px-6 text-white my-3 lg:mt-0"
                style={{ translateX: project1TranslateXRight }}
              >
                <h2 className="bg-yellow-300 w-max mx-auto lg:mx-0 text-black font-sans font-bold text-5xl drop-shadow-md shadow-black px-1">
                  {projects[2].name}
                </h2>
