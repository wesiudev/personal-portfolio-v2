...
export default function ProjectShowcase() {
  ...
  return (
    <div className="relative">
      ...
      <div ref={mainWrapper} className="flex w-screen sticky top-0 left-0 mt-[525vh]">
        <motionDiv.div className="sticky z-[504] top-0 left-0 w-screen flex flex-col  lg:mt-36 bg-blue-300">
          siema
