        ...
        >
          {projects.map((item: any, i: any) => (
            <motionDiv.div
              ...
              className="h-[100vh] flex items-center duration-75  px-6 lg:px-24"
            >
              <div className=" w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 lg::mt-0">
                ...
                <motionDiv.div
                  className="mx-3 lg:mx-6 text-white bg-slate-800 bg-opacity-70 overflow-hidden rounded-xl border-4 border-zinc-800"
                  style={{
                ...
                >
                  ...
                  <div className="p-3">
                    <p className="text-gray-200 mb-2">{item.type}</p>
                    <p className="text-3xl">{item.shortDescription}</p>
