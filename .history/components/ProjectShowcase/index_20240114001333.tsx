...
export default function ProjectShowcase() {
  ...
  return (
    <>
      ...
      >
        <div className="h-[20vh] lg:h-[50vh] relative w-screen">
          <motionDiv.h2
            style={{
            ...
            className=" bg-yellow-300 z-[550] sticky font-sans w-max top-24 text-3xl font-bold xl:text-7xl text-black select-none text-center"
          >
            Projects Showcase
          </motionDiv.h2>
        </div>
        ...
        <div className="z-[504] top-0 w-screen flex flex-col ">
          {projects.map((item: any, i: any) => (
            <div
              key={i}
              className="h-max py-3 lg:py-24 my-12 lg:my-0 flex items-center duration-75 px-6 lg:px-12"
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                <div className="relative ">
                  <div className="flex flex-row space-x-2 bottom-3 left-1/2 -translate-x-1/2 lg:-translate-x-0 lg:left-3 lg:top-1/2 lg:-translate-y-1/2 absolute lg:space-y-3 bg-black bg-opacity-60 p-1.5">
