    ...
    <>
      ...
      >
        <motionDiv.h2
          ...
          className="bg-black bg-opacity-40 z-[550] font-sans font-bold italic w-max text-2xl lg:text-5xl xl:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
