          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className=" w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 lg::mt-0">
                ...
                <motionDiv.div
                  className="mx-3 lg:mx-6 text-white bg-slate-800 bg-opacity-50 overflow-hidden rounded-xl border-4 border-zinc-800"
                  style={{ translateX: project1TranslateXRight }}
                >
                  <h2 className="bg-yellow-300 my-3 lg:mt-0 w-full rounded-b-xl mx-auto lg:mx-0 text-black font-sans font-bold text-5xl drop-shadow-md shadow-black px-1">
                    {item.name}
                  </h2>
                  <div className="p-3">
