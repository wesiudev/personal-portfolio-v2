    ...
    <>
      ...
      >
        <div className="sticky top-0 z-[504] w-screen h-screen">
          <div className="top-0 lg:top-36 -translate-x-1/2 left-[50%] h-screen lg:h-max flex items-center ">
            <motionDiv.div
              style={{
                translateY: project1Y,
                scale: project1Scale,
              }}
              className="sticky h-[100vh]  items-center flex w-max duration-75 py-3 px-3"
            >
