              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <h2 className="-ml-3 px-3 bg-yellow-300 rounded-br-xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                      Colors
                    </h2>
                    <div className="z-50 h-max flex flex-row -ml-2 lg:-ml-4 mt-3 p-2 bg-gray-200 bg-opacity-20 w-max rounded-br-xl">
                    ...
                    <p className="text-sm lg:text-base xl:text-lg font-lato">
                      {item.structure}
                    </p>
                    <h2 className="-ml-3 px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                      Fonts
