              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <div className="-ml-3 z-50 h-max flex flex-row lg:-ml-2 mt-3 p-2">
                    ...
                    <h2 className="-ml-3 px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl">
                      Stack
                    </h2>
