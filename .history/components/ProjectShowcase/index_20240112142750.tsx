            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-72 lg:mt-0">
                <motionDiv.div
                  ...
                  className="mx-3 lg:mx-6 relative bg-red-500"
                >
                  <Link
                    href={item.link}
                    title="Open in new tab"
                    target="_blank"
                    className="bg-black bg-opacity-50 rounded-xl p-2 border-2 border-black absolute bottom-6 left-1/2 -translate-x-1/2 text-blue-400 font-bold hover:text-blue-500 not-italic flex flex-row items-center mt-3 text-xl"
                  >
                    <FaLink className="mr-2 text-zinc-800" /> Visit website
                  </Link>
                  <Image
