    ...
    <>
      ...
      >
        <motionDiv.h2
          ...
          className="z-[500] font-sans font-bold italic text-4xl lg:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
        {/* <motionDiv.h2
        ...
        >
          ...
          >
            <div className="grid grid-cols-2 h-max">
              ...
              >
                <h2 className="bg-yellow-300 w-max text-black font-sans font-bold text-5xl drop-shadow-md shadow-black">
                  {projects[2].name}
                </h2>
          ...
          >
            <div className="grid grid-cols-2 h-max">
              ...
              <motionDiv.div
                ...
                style={{ translateX: project1TranslateXRight }}
              >
                <h2 className="bg-yellow-300 w-max font-sans font-bold text-5xl drop-shadow-md shadow-black">
                  {projects[1].name}
                </h2>
                <p className="font-sans text-3xl">
