    ...
    <>
      ...
      >
        <motionDiv.h2
          ...
          className="bg-black bg-opacity-40 !z-[550] relative font-sans font-bold italic w-max top-12 text-2xl lg:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
      </motionDiv.div>
