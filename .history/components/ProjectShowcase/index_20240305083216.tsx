              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <div className="-ml-3 z-50 h-max flex flex-row flex-wrap lg:-ml-4 mt-3 p-2 pr-6 bg-gray-300 bg-opacity-20">
                      {item.colors.map((color: any, i: number) => (
                        <li
                          key={i}
                          className={`flex flex-row items-center ml-2 lg:ml-4 flex-wrap mb-3`}
                        >
                          <div
