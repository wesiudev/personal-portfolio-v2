      ...
      >
        ...
        >
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max mt-72 lg:mt-36">
                <motionDiv.div
                  style={{
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    className="absolute right-3 left-3 xl:bottom-6 l xl:right-6 text-blue-400 hover:text-gray-400 hover:bg-slate-800 hover:bg-opacity-70 p-2 rounded-md duration-200 border-2 border-transparent hover:border-zinc-800 not-italic flex flex-row items-center mt-3 text-xl group"
                  >
