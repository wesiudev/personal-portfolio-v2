...
export default function ProjectShowcase({ menuOpacity }: { menuOpacity: any }) {
  ...
  const h2TextOpacity = useTransform(scrollYProgress, [0.2, 0.3], [0, 1]);
  ...
  return (
    <>
      ...
      >
        ...
        <motionDiv.h2
          style={{ translateY: h2TextTranslateY, opacity: h2TextOpacity }}
          className=" font-sans font-bold italic text-4xl lg:text-6xl text-white select-none text-center p-3 rounded-xl"
        >
          Blackbell Art
        </motionDiv.h2>
      ...
      >
        <div className="z-[502] sticky top-0 h-screen w-screen flex items-center justify-center text-white font-bold">
          SIEMA
        </div>
      </div>
    </>
