          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  <h2 className="bg-yellow-300 font-anta text-center mx-auto lg:mx-0 text-black font-bold text-2xl lg:text-3xl xl:text-5xl drop-shadow-md shadow-black px-1">
                    {item.name}
                  </h2>
                  <div className="p-3">
