    ...
    <>
      ...
      >
        <motionDiv.div
          ...
          className="h-[20vh] lg:h-[50vh] relative w-screen"
        >
          <motionDiv.h2 className="w-max bg-yellow-300 z-[550] sticky font-sans w-max top-24 text-3xl font-bold xl:text-7xl text-black select-none text-center">
            Projects Showcase
          </motionDiv.h2>
        </motionDiv.div>
