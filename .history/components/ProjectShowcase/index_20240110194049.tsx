...
export default function ProjectShowcase({ menuOpacity }: { menuOpacity: any }) {
  ...
  const project1 = useTransform(scrollYProgress, [0.2, 0.3], ["100vw", "0vw"]);
  ...
  return (
    <>
      ...
      <div
        ref={mainWrapper}
        className="h-[1000vh] w-screen z-[504] relative mt-[620vh] bg-blue-300"
      >
        <div className="sticky top-[25vh] w-screen h-screen">
