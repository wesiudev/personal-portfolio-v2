    ...
    <>
      ...
      >
        ...
        <motionDiv.h2
          ...
          className="fixed bottom-16 translate-x-1/2 -left-1/2 font-sans font-bold italic text-4xl lg:text-6xl text-black bg-yellow-300 select-none text-center p-3 rounded-xl"
        >
          Blackbell Art
        </motionDiv.h2>
      </motionDiv.div>
      <div
        ref={mainWrapper}
        className="h-[1000vh] w-screen relative mt-[400vh] bg-blue-300"
      ></div>
    </>
  );
}
