              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <div className="-ml-3 z-50 h-max flex flex-row lg:-ml-4 mt-3 p-2 from-gray-300 via-gray-200 to-gray-300 bg-gradient-to-br bg-opacity-20 w-max rounded-br-2xl pr-6">
