          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max mt-36">
                ...
                >
                  <h2 className="bg-yellow-300 w-full p-2 text-center mx-auto lg:mx-0 text-black font-sans font-bold text-4xl lg:text-3xl xl:text-5xl drop-shadow-md shadow-black px-1">
                    {item.name}
                  </h2>
                  <div className="p-3">
                    <p className="text-2xl lg:text-xl xl:text-2xl not-italic">
                      {item.shortDescription}
                    </p>
                    <p className="text-gray-400 my-2 not-italic">{item.type}</p>
                    <h2 className="font-bold text-2xl lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                      Stack
                    </h2>
                    <div className="flex flex-row items-start flex-wrap -ml-3">
                      {item.technologies.map((technology: any, i: any) => (
                        <p
                          key={i}
                          className="font-sans text-lg lg:text-base xl:text-lg ml-3"
                        >
                          {technology}
                        </p>
                      ))}
                    ...
                    <div className="flex flex-col items-start">
                      {item.fonts.map((font: any, i: any) => (
                        <div className="flex flex-row items-center">
                          <p
                            key={i}
                            className="font-sans text-lg lg:text-base xl:text-lg"
                          >
                            {font.fontName}
                          </p>
