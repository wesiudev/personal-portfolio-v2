              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-72 lg:mt-0">
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    className="absolute bottom-6 right-6 text-blue-400 hover:text-blue-500 not-italic flex flex-row items-center mt-3 text-xl"
                  >
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <h2 className="font-bold text-2xl mt-3 bg-yellow-300 text-black w-max px-2">
                      Stack
                    </h2>
