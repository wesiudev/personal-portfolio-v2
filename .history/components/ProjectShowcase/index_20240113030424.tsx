    ...
    <>
      ...
      >
        <motionDiv.h2
          ...
          className="hidden lg:block bg-black bg-opacity-40 z-[550] fixed left-12 font-sans w-max top-32 text-2xl lg:text-3xl xl:text-4xl text-white select-none text-center p-3 rounded-xl"
        >
          Projects Showcase
        </motionDiv.h2>
        <motionDiv.h2
