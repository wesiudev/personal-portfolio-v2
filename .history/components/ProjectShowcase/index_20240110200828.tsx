    ...
    <>
      ...
      >
        <div className="sticky top-36 z-[504] w-screen h-screen ">
          <div className="top-0 h-screen lg:h-max flex items-center">
            <motionDiv.div
            ...
            >
              ...
              <motionDiv.div style={{ translateX: project1TranslateXRight }}>
                <h2 className="font-lato font-bold text-5xl text-zinc-800 drop-shadow-md shadow-black">
                  {projects[2].name}
                </h2>
