  ...
  return (
    <div className="flex flex-col">
      <div className="relative h-max">
        <div className="absolute left-4 lg:left-8 top-3 bg-black bg-opacity-50 text-white p-1.5 py-0 rounded-md">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 h-max w-full px-4 lg:px-8 flex justify-between items-center">
          <button
            onClick={() =>
              setCurrentImage(
                currentImage < project.images.length && currentImage > 0
                  ? currentImage - 1
