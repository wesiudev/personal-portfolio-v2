          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 ">
                ...
                >
                  <h2 className="not-italic bg-yellow-300 my-3 lg:mt-0 w-full p-2 text-center mx-auto lg:mx-0 text-black font-sans font-bold text-5xl drop-shadow-md shadow-black px-1">
                    {item.name}
                  </h2>
                  <div className="p-3">
                    <p className="text-gray-200 mb-2 not-italic">{item.type}</p>
