      ...
      >
        ...
        >
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-72 lg:mt-36">
                <motionDiv.div
                  style={{
                    translateX: project1TranslateXLeft,
                  }}
                  className="mx-3 relative h-max"
                >
                  <Link
                    href={item.link}
                ...
                <motionDiv.div
                  className="italic mt-4 lg:mt-0 mx-3  text-white bg-slate-800 bg-opacity-70 overflow-hidden rounded-xl border-4 border-zinc-800 h-max"
                  style={{
