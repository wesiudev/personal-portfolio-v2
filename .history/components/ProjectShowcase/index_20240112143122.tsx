              ...
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-72 lg:mt-0">
                ...
                >
                  <Link
                    ...
                    target="_blank"
                    className="absolute bottom-6 right-6 text-blue-400 hover:text-blue-500 hover:bg-black bg-opacity-80 border-2 border-black not-italic flex flex-row items-center mt-3 text-xl"
                  >
