            ...
            >
              <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 h-max">
                ...
                >
                  ...
                  <div className="p-3">
                    <p className="text-gray-400 my-2 italic font-lato">
                      {item.type}
                    </p>
                    <p className="text-lg font-lato">{item.shortDescription}</p>{" "}
                    ...
                    <div className="flex flex-row items-start flex-wrap -ml-3">
                      {item.technologies.map((technology: any, i: any) => (
                        <p
                          key={i}
                          className="text-sm lg:text-base xl:text-lg ml-3 mt-3 font-lato"
                        >
                          {technology}
                        </p>
                      ))}
                    ...
                    <p className="text-sm lg:text-base xl:text-lg font-lato mt-3">
                      {item.structure}
                    </p>
                    <h2 className="-ml-3 px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl mt-3 lg:mt-1.5 xl:mt-3">
                      Fonts
                    ...
                    <div className="flex flex-col items-start mt-3">
                      {item.fonts.map((font: any, i: any) => (
                        <div className="flex flex-row items-center">
                          <p
                            key={i}
                            className="text-sm lg:text-base xl:text-lg font-lato"
                          >
                            {font.fontName}
                          </p>
                          ...
                          {font.variants.map((variant: any, i: any) => (
                            <div
                              className="text-sm ml-2 mt-[2px] text-gray-400 font-lato"
                              key={i}
                            >
                              {variant}
                            </div>
