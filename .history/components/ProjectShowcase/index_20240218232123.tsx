    ...
    <>
      ...
      >
        <motionDiv.div
          ...
          className="h-[30vh] lg:h-[50vh] relative w-screen flex justify-center"
        >
          <motionDiv.h2
            style={{
              boxShadow: "inset 0 0 10px #000000",
            }}
            className="bg-yellow-300 p-6 z-[550] sticky font-sans w-max h-max top-24 text-3xl font-bold xl:text-7xl text-black select-none text-center"
          >
            Projects Showcase
          </motionDiv.h2>
        </motionDiv.div>
