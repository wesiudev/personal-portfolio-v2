          ...
          {projects.map((item: any, i: any) => (
            ...
            >
              <div className=" w-full grid grid-cols-1 lg:grid-cols-2 h-max mt-12 ">
                ...
                <motionDiv.div
                  className="mx-3 lg:mx-6 text-white bg-slate-800 bg-opacity-70 overflow-hidden rounded-xl border-4 border-zinc-800 h-max"
                  style={{
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <h2 className="font-bold text-2xl mt-3 italic">Stack</h2>
                    ...
                    <h2 className="font-bold text-2xl mt-3 italic">Fonts</h2>
