                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 md:gap-4 lg:gap-0 xl:gap-4">
                      <div className="mt-3 flex flex-col border-2 border-yellow-300">
                        <h2 className="px-3 bg-yellow-300 rounded-br-2xl w-max text-zinc-800 font-anta text-lg lg:text-xl xl:text-2xl">
                          Colors
                        </h2>
                        <div className="z-50 h-max flex flex-row mt-3 p-2 pr-6 w-max bg-gray-300 bg-opacity-20">
