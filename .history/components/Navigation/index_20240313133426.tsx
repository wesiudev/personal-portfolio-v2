...
export function NavRight({ dictionary, lang }: { dictionary: any; lang: any }) {
  ...
  return (
    <div className="text-gray-300 fixed right-6 lg:right-12 top-12 flex flex-col rotate-90 sm:rotate-0 sm:flex-row space-x-3 z-[1000] font-regular text-xl font-anta">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
