...
export const NavRight: React.FC = () => {
  ...
  return (
    <div className="lg:flex hidden fixed right-12 top-12 flex-col-reverse lg:flex-col items-start w-max h-max lg:space-y-3 z-[250] font-regular text-xl">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
      ...
      >
        <div className="relative group-hover:text-white duration-200 p-0.5 px-2">
          ...
          <div className="z-[50] relative font-light bg-black bg-opacity-20">
            Portfolio
          </div>
        </div>
      </ScrollTo>
