...
export const NavLeft: React.FC = () => {
  return (
    <div
      data-aos="fade-in"
      data-aos-delay={2600}
      className="fixed left-6 lg:left-12 bottom-12 flex flex-col items-center justify-center space-y-3 z-[550] group bg-black bg-opacity-50 p-1.5"
    >
      <Link
        target="_blank"
        title="Przejdź do Github.com"
        href="https://github.com/wesiudev"
        className="opacity-70 hover:opacity-100 duration-200 text-gray-400"
      >
