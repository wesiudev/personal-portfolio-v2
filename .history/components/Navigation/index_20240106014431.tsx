...
export const NavRight: React.FC = () => {
  ...
  return (
    <div className="lg:flex hidden fixed right-12 top-12 flex-col-reverse lg:flex-col items-start w-max h-max space-y-3 lg:space-y-0 lg:space-x-6 z-[250] font-regular text-3xl ">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
