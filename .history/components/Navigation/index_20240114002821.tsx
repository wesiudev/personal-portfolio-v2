...
export const NavLeft: React.FC = () => {
  return (
    <div className="fixed left-6 lg:left-12 bottom-12 flex flex-row items-center justify-center space-x-3 z-[550] group bg-black bg-opacity-30 p-1.5 rounded-xl">
      <Link
        target="_blank"
