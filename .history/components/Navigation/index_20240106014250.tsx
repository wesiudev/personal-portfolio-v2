...
export const NavRight: React.FC = () => {
  ...
  return (
    <div className="lg:flex hidden fixed right-12 top-12 flex-col-reverse lg:flex-row space-y-3 lg:space-y-0 lg:space-x-6 z-[250] font-regular text-3xl ">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
        ...
        data-aos="fade-down"
        data-aos-delay={2600}
        className="group h-max overflow-hidden cursor-pointer flex flex-col items-center"
      >
        <div className="font-light bg-green-600 p-0.5 px-2 z-[50]">
