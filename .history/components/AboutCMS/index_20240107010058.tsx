...
const About = () => {
  ...
  const aboutMeX = useTransform(scrollYProgress, [0.3, 0.8], ["-40vw", "0vw"]);
  ...
  return (
    ...
    >
      <motion.h2
        style={{ x: aboutMeX, position }}
        className="text-7xl font-bold mb-4 top-16 text-center text-zinc-700 drop-shadow-lg shadow-black duration-75"
      >
        About Me
      </motion.h2>
