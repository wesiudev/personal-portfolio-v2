...
const About = () => {
  ...
  const aboutMeX = useTransform(scrollYProgress, [0.3, 0.6], ["-40vw", "0vw"]);

  return (
    <motion.div ref={wrapper} className="container mx-auto my-16 p-8 h-screen">
      <motion.h2 style={{ x: aboutMeX }} className="text-7xl font-bold mb-4">
        About Me
      </motion.h2>
