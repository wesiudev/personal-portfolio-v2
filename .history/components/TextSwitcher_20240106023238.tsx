...
const TextSwitcher = () => {
  ...
  return (
    <div
      className={`flex flex-row items-center justify-center text-rotator bg-gradient-to-r from-green-500 to-green-700 ease-in-out bg-clip-text text-transparent w-[95vw] px-6 ${
        animate ? "animate" : ""
      }`}
    >
