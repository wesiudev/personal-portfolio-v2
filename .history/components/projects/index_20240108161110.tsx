      ...
      >
        <div className="sticky top-0 lg:top-36 h-screen lg:h-max flex items-center overflow-x-hidden">
          <motion.div
            ...
            className="sticky flex items-end z-0 h-[50vh] w-max duration-75"
          >
        ...
        <motion.h2
          ...
          className="fixed right-12 top-24 lg:top-auto lg:bottom-12 text-7xl 2xl:text-8xl font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
        >
          portfolio <br className="lg:hidden" /> projects
        </motion.h2>
      </div>
