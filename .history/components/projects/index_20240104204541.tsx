...
export default function Projects() {
  ...
  const textFromRight = useTransform(
    scrollYProgress,
    [0, 0.3, 1],
    ["150%", "50%", width && width > 1366 ? "-30%" : "-100%"]
  );
  ...
  return (
    <>
      <div
        ...
        id="projects"
      >
        <div className="sticky top-0 lg:top-36 h-screen lg:h-max lg:block flex items-center">
          <motion.div
            style={{
              translateX: xPortfolioItems,
              transitionDuration: `${duration}ms`,
            }}
            className="flex z-0 h-[50vh] w-max duration-75"
          >
        ...
        <div className="sticky z-[500] bottom-36 lg:bottom-12">
          <motion.h2
            style={{ translateX: textFromRight, color, opacity: opacity }}
            className="text-6xl lg:text-7xl 2xl:text-8xl font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
          >
            portfolio projects
          </motion.h2>
        </div>
