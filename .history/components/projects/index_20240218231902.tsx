  ...
  return (
    <>
      ...
      >
        ...
        <motion.h2
          className="shadow-inner px-6 fixed right-12 top-24 lg:top-auto lg:bottom-12 text-7xl 2xl:text-8xl font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
          style={{
