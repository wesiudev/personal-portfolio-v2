...
export default function Projects() {
  ...
  const xPortfolioItems = useTransform(
    scrollYProgress,
    [0.1, 0.2, 1],
    ["100%", "50%", width && width > 1366 ? "-50%" : "-100%"]
  );
  return (
    <>
      <div
        ...
        className="flex p-6 pt-24 lg:p-12 2xl:pt-36 relative h-[300vh] lg:h-[200vh]"
        id="projects"
      >
        ...
        <motion.h2
          ...
          className="fixed right-12 bottom-16 lg:bottom-12 text-4xl lg:text-6xl 2xl:text-8xl font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
        >
          portfolio projects
        </motion.h2>
      </div>
