...
export default function Project({
  ...
  return (
    <div
      ...
      className={`min-h-screen flex relative p-6 py-12 lg:p-12 xl:p-16 !z-0 ${
      ...
      <div className="flex flex-col">
        ...
        >
          <p
            ...
            } drop-shadow-lg shadow-black font-light mb-2 text-2xl font-bold`}
          >
            {project.type}
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 w-[90vw] lg:w-[80%] mt-12 gap-6">
