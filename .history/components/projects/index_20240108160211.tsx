  ...
  return (
    <>
      <div
        ...
        className="flex p-6 pt-24 lg:p-12 2xl:pt-36 relative h-[300vh] xl:h-[200vh] overflow-x-hidden"
        id="projects"
      >
        <div className="sticky top-0 lg:top-36 h-screen lg:h-max flex items-center">
          <motion.div
            style={{
