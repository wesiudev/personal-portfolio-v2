...
const TextSwitcher = () => {
  ...
  return (
    <div
      className={`flex flex-row items-center justify-center text-rotator bg-gradient-to-r from-green-300 to-green-700 bg-clip-text text-transparent w-[95vw] px-6 ${
        animate ? "animate" : ""
      }`}
    >
