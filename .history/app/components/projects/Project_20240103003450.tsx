  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="flex flex-col bg-black bg-opacity-50 rounded-xl p-3 w-max">
          <p
            data-aos="fade"
            data-aos-delay="200"
            className="text-xl text-left text-gray-400 drop-shadow-lg shadow-black font-light mt-2"
          >
            {project.type}
          </p>
        </div>
