...
export default function Project({
  ...
  return (
    <div
      ...
      className={`min-h-screen w-screen flex relative p-6 py-12 lg:p-12 xl:p-16 !z-0 ${
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-[90vw] lg:w-[80%] mt-12 gap-6">
