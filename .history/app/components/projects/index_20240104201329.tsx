  ...
  return (
    <>
      <div
        ...
        className="flex p-6 pt-24 lg:p-12 2xl:pt-36 relative h-[300vh]"
        id="projects"
      >
        <div className="sticky top-36 bg-green-400">
          <motion.div
            style={{
        ...
        <motion.h2
          ...
          className="fixed right-12 bottom-16 lg:bottom-12 text-4xl lg:text-6xl 2xl:text-8xl duration-500 font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
        >
          portfolio projects
        </motion.h2>
      </div>
