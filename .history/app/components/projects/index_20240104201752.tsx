    ...
    <>
      ...
      >
        ...
        <motion.h2
          ...
          className="fixed right-12 bottom-16 lg:bottom-12 text-4xl lg:text-6xl 2xl:text-8xl duration-75 font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
        >
          portfolio projects
        </motion.h2>
      </div>
