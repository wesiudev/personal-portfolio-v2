...
export default function Projects() {
  ...
  const opacity = useTransform(scrollYProgress, (pos) => (pos >= 1 ? 0 : 1));
    ...
    <>
      ...
      >
        <motion.h2
          ...
          className="fixed right-12 bottom-12 text-4xl lg:text-6xl 2xl:text-8xl duration-400 font-bold drop-shadow-2xl shadow-black w-max mx-auto lg:mx-0"
        >
          portfolio projects
        </motion.h2>
        <motion.div
          style={{ translateX: xPortfolioItems, opacity }}
          className="flex fixed top-36 z-0"
        >
