  ...
  return (
    ...
    >
      <Link
        ...
        className="opacity-50 group-hover:opacity-100 duration-200"
      >
      ...
      <div className="w-px h-24 bg-black hidden lg:block opacity-50 group-hover:opacity-100 duration-200"></div>
    </div>
  );
}
