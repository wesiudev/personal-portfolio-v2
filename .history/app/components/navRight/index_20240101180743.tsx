...
export default function NavRight({
  ...
  return (
    <div className="fixed right-12 top-12 flex flex-col-reverse lg:flex-row space-y-3 lg:space-y-0 lg:space-x-6 z-[150] font-regular text-3xl italic">
      ...
      >
        <div className="overflow-hidden mr-2 font-light bg-purple-500 rotate-6 p-0.5 bg-opacity-80">
          <div className="-rotate-6">01.</div>
        </div>
        <div className="relative">
          <div className="absolute -left-[120%] top-0 h-full w-full bg-purple-500 bg-opacity-80 p-0.5"></div>
          Projekty
        </div>
      </ScrollTo>
      <button
