...
export default function NavRight({
  ...
  return (
    <div className="lg:block hidden fixed right-12 top-12 flex flex-col-reverse lg:flex-row space-y-3 lg:space-y-0 lg:space-x-6 z-[150] font-regular text-3xl italic">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
      ...
      >
        ...
        <div className="relative group-hover:text-white duration-200 p-0.5 px-2">
          <div className="absolute -left-[120%] group-hover:-left-0 duration-300 ease-in-out top-0 h-full w-full bg-purple-500 "></div>
          <div className="z-[50] relative">About</div>
        </div>
      </button>
    </div>
  );
