...
export default function NavRight({
  ...
  return (
    <div className="lg:flex hidden fixed right-12 top-12 flex-col-reverse lg:flex-row space-y-3 lg:space-y-0 lg:space-x-6 font-regular text-3xl italic z-[250]">
      <ScrollTo
        to="projects"
        smooth={true}
        duration={500}
      ...
      >
        <div className="font-light bg-purple-500 p-0.5 px-2 relative ">
