...
export default function NavRight({
  ...
  return (
    <div className="fixed right-12 top-12 flex flex-col-reverse lg:flex-row space-y-3 lg:space-y-0 lg:space-x-6 z-[150] font-regular text-3xl italic">
      ...
      >
        <div className="mr-2 font-light bg-purple-500 p-0.5 z-[50]">
          <div className="">01.</div>
        </div>
        <div className="relative group-hover:text-white delay-150 p-0.5">
          <div className="absolute -left-[120%] group-hover:-left-0 duration-150 top-0 h-full w-full bg-purple-500 "></div>
          <div className="z-[50] relative">Projekty</div>
        </div>
      </ScrollTo>
      <button
      ...
      >
        <div className="mr-2 font-light bg-purple-500 p-0.5 bg-opacity-80">
