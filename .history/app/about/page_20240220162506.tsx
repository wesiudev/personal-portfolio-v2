...
export default function Page() {
  ...
  return (
    <>
      <div className="z-[10] fixed top-0 left-0 w-screen h-screen bg-gradient-to-br from-zinc-900 via-purple-900 to-zinc-900"></div>
      <StarsBg />
      <div className="mt-24 w-full py-8 flex flex-row z-[600] relative">
        {timeline.map((item: any, i: any) => (
          <div key={i} className="rounded-3xl border-slate-800 bg-slate-500">
            <p>{item.year}</p>
            <h2>{item.title}</h2>
