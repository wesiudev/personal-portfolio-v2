...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="mt-24 py-8 flex flex-col items-center z-[600] relative w-max md:w-[980px] mx-auto space-y-6">
...
const RoadmapItem = ({
  ...
  <div
    className={`text-white w-[300px] sm:w-[200px] lg:w-[448px] rounded-xl border-2 border-slate-900 bg-slate-800 ${
