    ...
    <>
      ...
      >
        <div className="bg-slate-800 p-3 py-12 border-y-2 border-slate-900 md:px-12">
          <div className="md:w-[675px] lg:w-[900px] mx-auto text-white">
            <h2 className="text-white drop-shadow-xl shadow-black text-3xl lg:text-4xl 2xl:text-5xl font-bold">
              <span className="text-yellow-300">Motivation to code</span>
            </h2>
            <h3 className="drop-shadow-xl shadow-black text-xl lg:text-2xl xl:text-3xl font-bold mt-6">
              Logic
            </h3>
            ...
            <h3 className="drop-shadow-xl shadow-black text-xl lg:text-2xl xl:text-3xl font-bold mt-3">
              Learning
            </h3>
            <p className="font-dosis text-base lg:text-xl">
