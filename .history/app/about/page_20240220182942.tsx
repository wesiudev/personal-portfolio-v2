...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="mt-24 py-8 flex flex-col items-center z-[600] relative w-max md:w-[617px] lg:w-[980px] mx-auto space-y-6">
        <div className="absolute left-[-42px] md:left-[50%] top-0 md:-translate-x-[50%] h-full w-1 bg-yellow-300 z-[600] rounded-full"></div>
        <div className="text-white font-bold text-2xl p-3 absolute left-[50%] top-[50%] -translate-y-[50%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-slate-900 z-[600] rounded-xl">
          How it started?
        </div>
