...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="mt-24 py-8 flex flex-col items-center z-[600] relative lg:w-[980px] mx-auto h-full">
        <div className="left-[50%] top-0 -translate-x-[50%] h-full w-2 bg-yellow-300"></div>
