...
const RoadmapItem = ({
  ...
  <div
    className={`text-white w-[300px] sm:w-[400px] md:w-[300px] lg:w-[410px] rounded-xl border-2 border-slate-900 bg-slate-800 ${
      alignLeft ? "md:mr-auto rounded-tr-none" : "md:ml-auto rounded-tl-none"
    } relative`}
  >
    <div
    ...
    >
      <div
        className={`font-anta bg-yellow-300 rounded-br-xl rounded-tl-xl px-3 py-1 w-max text-zinc-800 shadow-sm shadow-black ${
          alignLeft
