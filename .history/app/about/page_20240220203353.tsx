  ...
  return (
    <>
      ...
      <div
        ...
        className="w-screen flex flex-col items-center z-[600] relative mt-24"
      >
        <h2 className="text-[#F7E11F] text-3xl 2xl:text-7xl lg:text-center font-bold w-max mx-auto">
          Motivation
        </h2>
        <p className="text-white font-dosis w-full lg:w-1/2 text-base lg:text-xl mt-6">
          I find immense satisfaction in working with data that I can visualize.
          Observing the flow of information between the components I create is a
          source of great fascination for me. I am captivated by the logic of
          applications and the optimization process. Designing and implementing
          new features excites me, and I am constantly driven to innovate. My
          passion for programming fuels my desire for continuous growth, and I
          actively pursue opportunities to further develop my skills.
        </p>
...
const RoadmapItem = ({
  ...
  <div
    className={`text-white w-[300px] sm:w-[400px] md:w-[300px] lg:w-[410px] rounded-xl border-2 border-slate-900 bg-slate-800 ${
      alignLeft
