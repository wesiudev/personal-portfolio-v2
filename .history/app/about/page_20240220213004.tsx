...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        <div className="top-0 h-2 w-full bg-transparent absolute -left-[50%] translate-x-[50%] group-hover:bg-yellow-300 scale-x-0 group-hover:scale-x-100 duration-[1500ms]"></div>
