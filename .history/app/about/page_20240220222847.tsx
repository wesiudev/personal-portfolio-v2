            ...
            <div className="mt-24">
              ...
              <ul>
                <li className="relative">
                  <div className="absolute top-1/2 -translate-y-1/2 w-2 h-2 bg-white rounded-full left-0 -translate-x-[130%]"></div>
                ...
                <li className="relative">
                  <div className="absolute top-[3px] w-2 h-2 bg-white rounded-full left-0 -translate-x-[130%]"></div>
