...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="mt-24 py-8 flex flex-col items-center z-[600] relative w-max lg:w-[980px] mx-auto space-y-6">
        <div className="absolute left-[-42px] lg:left-[50%] top-0 lg:-translate-x-[50%] h-full w-1 bg-yellow-300 z-[600] rounded-full"></div>
...
const RoadmapItem = ({
  ...
  <div
    className={`text-white w-[300px] sm:w-[400px] lg:w-[448px] rounded-xl border-2 border-slate-900 bg-slate-800 ${
  ...
  >
    <div
      className={`absolute top-[50%] -translate-y-[50%] ${
        alignLeft
          ? "lg:-right-[42px] lg:left-auto -left-[42px]"
          : "-left-[42px]"
    ...
    >
      <div
        className={`bg-yellow-300 rounded-br-xl rounded-tl-xl px-3 py-1 w-max text-zinc-800 shadow-sm shadow-black ${
          alignLeft
            ? "lg:rounded-bl-xl lg:rounded-tr-xl lg:rounded-br-none lg:rounded-tl-none"
