      ...
      >
        <div className="bg-slate-800 p-3 py-12 relative">
          ...
          <div className="md:w-[675px] lg:w-[900px] mx-auto text-white z-[50]">
            <h2 className="text-white drop-shadow-xl shadow-black text-3xl lg:text-4xl 2xl:text-5xl font-bold relative">
              <FaCode className="text-gray-300 w-[75px] h-[75px] z-[25] absolute -translate-x-[120%] opacity-10 top-1/2 -translate-y-1/2" />
