  ...
  return (
    <>
      ...
      <div className="mt-36 pt-8 pb-12 flex flex-col items-center z-[600] relative w-max md:w-[675px] lg:w-[900px] mx-auto space-y-6">
        ...
        <div className="text-white font-bold text-2xl p-2 absolute -left-[20%] md:left-[50%] bottom-[0%] translate-y-[125%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-yellow-300 z-[600] rounded-xl px-12">
          Download Resume
        </div>
