  ...
  return (
    <>
      ...
      <div className="mt-36 py-8 flex flex-col items-center z-[600] relative w-max md:w-[617px] lg:w-[980px] mx-auto space-y-6">
        ...
        <div className="text-white font-bold text-2xl p-3 absolute -left-[20%] md:left-[50%] top-[0%] -translate-y-[138%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-yellow-300 z-[600] rounded-xl px-12">
          How it started?
        </div>
