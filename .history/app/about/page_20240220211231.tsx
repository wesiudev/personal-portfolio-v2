    ...
    <>
      ...
      >
        <div className="bg-slate-800 p-3 py-12 relative">
          <FaCode className="text-gray-300 w-[125px] h-[125px] xl:w-[200px] xl:h-[200px] z-[25] absolute right-12 xl:right-auto xl:left-24 top-[10%] -translate-y-1/2 opacity-10" />
