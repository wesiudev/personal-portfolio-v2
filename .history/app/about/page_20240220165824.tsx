  ...
  return (
    <>
      ...
      <div className="mt-24 py-8 flex flex-col items-center z-[600] relative lg:w-[980px] mx-auto space-y-6">
        <div className="absolute left-[50%] top-0 -translate-x-[50%] h-full w-1 bg-yellow-300 z-[600] rounded-full"></div>
  ...
  >
    <div
      className={`absolute top-[50%] -translate-y-[50%] ${
        alignLeft
          ? "-left-[42px] lg:translate-x-[100%] lg:-right-[42px]"
          : "-left-[42px] lg:left-[-42px]"
