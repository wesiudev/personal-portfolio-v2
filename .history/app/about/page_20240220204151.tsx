...
export default function Page() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-slate-800 p-3 py-12">
          <h2 className="text-[#F7E11F] text-3xl 2xl:text-7xl md:w-[675px] lg:w-[900px] font-bold mx-auto">
            Motivation
          </h2>
          <p className="text-white font-dosis lg:w-1/2 text-base lg:text-xl mt-3 mx-auto">
            I find immense satisfaction in working with data that I can
            visualize. Observing the flow of information between the components
            I create is a source of great fascination for me. I am captivated by
            the logic of applications and the optimization process. Designing
            and implementing new features excites me, and I am constantly driven
            to innovate. My passion for programming fuels my desire for
            continuous growth, and I actively pursue opportunities to further
            develop my skills.
          </p>
        </div>
