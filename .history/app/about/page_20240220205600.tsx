      ...
      >
        <div className="bg-slate-800 p-3 py-12 border-y-2 border-slate-900 md:px-12">
          <div className="md:w-[675px] lg:w-[900px] mx-auto">
            <h2 className="text-white drop-shadow-xl shadow-black text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold">
              My reasons to <span className="text-yellow-300">Code</span>
            </h2>
            <h3 className="text-yellow-300 drop-shadow-xl shadow-black text-xl lg:text-2xl xl:text-3xl font-bold mt-3">
              Visualization
            </h3>
            <p className="text-white font-dosis text-base lg:text-xl">
