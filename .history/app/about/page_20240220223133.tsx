    ...
    <>
      ...
      >
        ...
        <div className="bg-slate-800 p-3 py-12 relative">
          ...
          <div className="mt-24">
            <button className="text-white font-bold text-2xl p-2 absolute -left-[20%] md:left-[50%] bottom-[0%] translate-y-[98%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-yellow-300 z-[600] rounded-xl px-12">
              Download Resume
            </button>
          </div>
        </div>
