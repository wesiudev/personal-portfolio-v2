...
export default function Page() {
  return (
    <>
      ...
      <div
        id="about"
        className="w-screen flex flex-col items-center text-center z-[600] relative min-h-screen mt-24"
      >
        ...
        <div className="text-[#F7E11F] text-lg lg:text-2xl space-y-12 w-[80vw] lg:w-[70vw] xl:w-[60vw] mt-16">
          <p className="bg-black bg-opacity-30 p-4">
          ...
          <p p className="bg-black bg-opacity-30 p-4">
