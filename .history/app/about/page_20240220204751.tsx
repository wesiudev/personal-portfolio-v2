  ...
  return (
    <>
      ...
      <div className="mt-36 pt-8 pb-12 flex flex-col items-center z-[600] relative w-max md:w-[675px] lg:w-[900px] mx-auto space-y-6">
        ...
        <div className="absolute md:left-[50%] md:-translate-x-[50%] h-full w-1 bg-yellow-300 top-48 z-[600] rounded-full"></div>
      ...
      >
        <div className="bg-slate-800 p-3 py-12 border-2 border-slate-900 md:w-max md:mx-auto md:px-12 md:rounded-3xl md:rounded-tl-none">
