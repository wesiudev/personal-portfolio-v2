    ...
    <>
      ...
      >
        <div className="bg-slate-800 p-3 py-12">
          <div className="md:w-[675px] lg:w-[900px] ">
            <h2 className="text-[#F7E11F] text-3xl 2xl:text-7xl font-bold mx-auto">
              Motivation
            </h2>
            <p className="text-white font-dosis text-base lg:text-xl mt-3 mx-auto">
