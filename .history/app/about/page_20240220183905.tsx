...
export default function Page() {
  ...
  return (
    <>
      ...
      <div className="mt-36 py-8 pb-12 flex flex-col items-center z-[600] relative w-max md:w-[675px] lg:w-[900px] mx-auto space-y-6">
        <div className="absolute left-[-42px] md:left-[50%] top-0 md:-translate-x-[50%] h-full w-1 bg-yellow-300 z-[600] rounded-full"></div>
        <div className="text-white font-bold text-2xl p-2 absolute -left-[20%] md:left-[50%] top-[0%] -translate-y-[138%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-yellow-300 z-[600] rounded-xl px-12">
          About me
        </div>
        <div className="text-white font-bold text-2xl p-2 absolute -left-[20%] md:left-[50%] bottom-[0%] translate-y-[128%] md:-translate-x-[50%] h-max w-max bg-slate-800 border-2 border-yellow-300 z-[600] rounded-xl px-12">
          Download Resume
        </div>
...
const RoadmapItem = ({
  ...
  >
    ...
    >
      ...
      <h2 className="px-3 py-1 font-bold md:text-xl">{item.title}</h2>
    </div>
