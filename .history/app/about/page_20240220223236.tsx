      ...
      >
        ...
        <div className="bg-slate-800 p-3 py-12 relative">
          ...
          <div className="md:w-[675px] lg:w-[900px] mx-auto text-white z-[50]">
            ...
            <div className="mt-12">
              <button className="text-white font-bold text-2xl p-2 h-max w-max bg-slate-800 hover:bg-slate-700 duration-300 border-2 border-yellow-300 z-[600] rounded-xl px-12">
                Download Resume
              </button>
            </div>
          </div>
