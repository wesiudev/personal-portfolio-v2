    ...
    <>
      ...
      >
        <div className="bg-slate-800 p-3 py-12 relative">
          <FaCode className="text-gray-300 w-[200px] h-[200px] z-[25] absolute left-24 top-[50%] -translate-y-1/2 opacity-30" />

          <RiComputerLine className="text-gray-300 w-[200px] h-[200px] z-[25] absolute right-24 top-[50%] -translate-y-1/2 opacity-30" />
