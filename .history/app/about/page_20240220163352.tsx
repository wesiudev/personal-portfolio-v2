...
export default function Page() {
  ...
  return (
    <>
      ...
      <StarsBg />
      <div className="mt-24 w-full py-8 flex flex-row z-[600] relative space-x-6 overflow-x-scroll mx-4 sm:mx-12 lg:mx-16 xl:mx-24">
        {timeline.map((item: any, i: any) => (
          <div
            key={i}
            className="text-white min-w-[400px] rounded-xl border-2 border-slate-900 bg-slate-800"
          >
