...
export default async function Page() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-black via-zinc-800 to-black scale-150 w-full min-h-screen">
      <StarsBg />
      <div
        className={`w-full px-5 lg:px-[8vw] xl:px-[12vw] pt-12 min-h-[60vh] z-[1000] relative`}
      >
