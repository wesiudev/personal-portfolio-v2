...
const CustomQAComponent = ({
  ...
  <details className="relative bg-green-500">
    <summary className="text-xl font-bold mb-2 py-8 outline-none cursor-pointer text-white relative w-full ">
      {question}
    </summary>
    <div className="px-4 pb-4 absolute left-[12px] top-0">
      <p className="font-circular text-[24px] text-white w-[720px] h-max ml-[550px] bg-red-500">
        {answer}
      </p>
    </div>
  </details>
