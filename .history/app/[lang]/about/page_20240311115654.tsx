...
const CustomQAComponent = ({
  ...
  <details className="relative flex flex-row items-center">
    <summary className="text-xl font-bold mb-2 py-8 outline-none cursor-pointer text-white relative w-full flex flex-row items-center ">
      {question}
      <div className="px-4 pb-4">
        <p className="font-circular text-[24px] text-white w-[720px] h-[280px] ml-[550px] bg-red-500">
          {answer}
        </p>
      </div>
    </summary>
