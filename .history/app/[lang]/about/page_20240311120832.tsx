    ...
    <>
      ...
      >
        ...
        <div className="bg-slate-800 p-3 py-12 relative">
          ...
          <div
            className="faq container flex flex-col p-4 md:p-8 mt-24 mb-40 mx-auto"
            data-aos="fade-up"
          >
            <h2 className="mb-12 text-[32px] font-youth text-center text-white bg-red-500">
...
const CustomQAComponent = ({
  ...
  <details className="relative bg-green-500">
    ...
    <div className="px-4 pb-4 lg:absolute lg:left-3 lg:top-0">
