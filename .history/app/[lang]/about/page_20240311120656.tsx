    ...
    <>
      ...
      >
        ...
        <div className="bg-slate-800 p-3 py-12 relative">
          ...
          <div
            className="faq container flex flex-col items-center justify-center p-4 md:p-8 mt-24 mb-40 w-full"
            data-aos="fade-up"
          >
            <h2 className="mb-12 text-[32px] font-youth text-center text-white w-max mx-auto">
              Frequently Asked Questions
            </h2>
            <div className="qa flex flex-col divide-y w-full">
              <CustomQAComponent question="Q?" answer="A" />
            </div>
          </div>
        </div>
        <Footer />
...
const CustomQAComponent = ({
  ...
  <details className="relative bg-green-500">
    <summary className="text-xl font-bold mb-2 outline-none cursor-pointer text-white relative w-full ">
      {question}
    </summary>
    <div className="px-4 pb-4 lg:absolute lg:left-3 lg:top-0 w-full">
      <p className="font-circular text-[24px] text-white w-full lg:max-w-[550px] h-max bg-red-500">
        {answer}
      </p>
    </div>
  </details>
